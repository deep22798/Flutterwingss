...
class navigationdrawercode extends StatefulWidget {
  const navigationdrawercode({Key? key}) : super(key: key);

  @override
  _navigationdrawercodeState createState() => _navigationdrawercodeState();
}

class _navigationdrawercodeState extends State<navigationdrawercode> {
  String data="";
  fetchFileData()async{
    String responseText;
    responseText =await rootBundle.loadString('text/customnavigationdrawer.txt');
    setState(() {
      data=responseText;
    });
  }
    ...
    return Scaffold(
      appBar: AppBar(iconTheme: IconThemeData(color: Colors.white),
        ...
        title: Padding(
          ...
          child: Center(child: Text("Custom Navigation Drawer Codes",style: TextStyle(color: Colors.white),)),
        ),
      ),
      body: Padding(
        padding: const EdgeInsets.all(8.0),
