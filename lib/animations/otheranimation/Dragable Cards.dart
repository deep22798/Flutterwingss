...
class _draggablecardsState extends State<draggablecards> {
  String data="";
  fetchFileData()async{
    String responseText;
    responseText =await rootBundle.loadString('text/draggablecards.txt');
    setState(() {
      data=responseText;
    });
  }
    ...
    return Scaffold(
      appBar: AppBar(iconTheme: IconThemeData(color: Colors.white),
        ...
        title: Padding(
          ...
          child: Center(child: Text("Dragable Cards",style: TextStyle(color: Colors.white),)),
        ),
      ),
      body: Padding(
