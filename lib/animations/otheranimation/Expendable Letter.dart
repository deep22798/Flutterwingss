...
class expendableletters extends StatefulWidget {
  @override
  _expendablelettersState createState() => _expendablelettersState();
}

class _expendablelettersState extends State<expendableletters> {
  String data="";
  fetchFileData()async{
    String responseText;
    responseText =await rootBundle.loadString('text/expendableletters.txt');
    setState(() {
      data=responseText;
    });
  }
    ...
    return Scaffold(
      appBar: AppBar(iconTheme: IconThemeData(color: Colors.white),
        ...
        title: Padding(
          ...
          child: Center(child: Text("Expendable Letter",style: TextStyle(color: Colors.white),)),
        ),
      ),
      body: Padding(
