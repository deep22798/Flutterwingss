...
class hpd7 extends StatefulWidget {
  @override
  _hpd7State createState() => _hpd7State();
}

class _hpd7State extends State<hpd7> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      appBar: AppBar(iconTheme: IconThemeData(color: Colors.white),
        ...
        title: Padding(
          ...
          child: Center(child: Text("HomePage Design 7 Codes",style: TextStyle(color: Colors.white),)),
        ),
      ),
      body: Stack(
        children: [
          ...
          Align(alignment: Alignment.bottomCenter,
            child: FlatButton(color:Colors.teal,onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>hpd7codes()));
...
class hpd7codes extends StatefulWidget {
  const hpd7codes({Key? key}) : super(key: key);

  @override
  _hpd7codesState createState() => _hpd7codesState();
}

class _hpd7codesState extends State<hpd7codes> {
  String data="";
  fetchFileData()async{
    String responseText;
    responseText =await rootBundle.loadString('text/hpd7.txt');
    setState(() {
      data=responseText;
    });
  }
