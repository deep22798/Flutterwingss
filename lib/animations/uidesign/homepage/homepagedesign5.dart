...
class hpd5 extends StatefulWidget {
  @override
  _hpd5State createState() => _hpd5State();
}

class _hpd5State extends State<hpd5>
        ...
        children: [
          ...
          Align(alignment: Alignment.bottomCenter,
            child: FlatButton(color:Colors.teal,onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>hpd5codes()));
...
class hpd5codes extends StatefulWidget {
  const hpd5codes({Key? key}) : super(key: key);

  @override
  _hpd5codesState createState() => _hpd5codesState();
}

class _hpd5codesState extends State<hpd5codes> {
  String data="";
  fetchFileData()async{
    String responseText;
    responseText =await rootBundle.loadString('text/hpd5.txt');
    setState(() {
      data=responseText;
    });
  }
    ...
    return Scaffold(
      appBar: AppBar(iconTheme: IconThemeData(color: Colors.white),
        ...
        title: Padding(
          ...
          child: Center(child: Text("HomePage Design 5 Codes",style: TextStyle(color: Colors.white),)),
        ),
      ),
      body: Padding(
