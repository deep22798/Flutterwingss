  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(iconTheme: IconThemeData(color: Colors.white),
        backgroundColor: Colors.teal,shadowColor: Colors.transparent,actions: [
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Center(child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>hpd4codes()));
                },
        ...
        title: Padding(
          ...
          child: Center(child: Text("HomePage Design 4",style: TextStyle(color: Colors.white),)),
        ),
      ),
...
class hpd4codes extends StatefulWidget {
  const hpd4codes({Key? key}) : super(key: key);

  @override
  _hpd4codesState createState() => _hpd4codesState();
}

class _hpd4codesState extends State<hpd4codes> {
  String data="";
  fetchFileData()async{
    String responseText;
    responseText =await rootBundle.loadString('text/hpd4.txt');
    setState(() {
      data=responseText;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(iconTheme: IconThemeData(color: Colors.white),
        ...
        title: Padding(
          padding: const EdgeInsets.only(right: 50),
          child: Center(child: Text("HomePage Design 4 Codes",style: TextStyle(color: Colors.white),)),
        ),
      ),
      body: Padding(
        padding: const EdgeInsets.all(8.0),
