...
class splashrippleeffectt extends StatefulWidget {
  const splashrippleeffectt({Key? key}) : super(key: key);

  @override
  _splashrippleeffecttState createState() => _splashrippleeffecttState();
}

class _splashrippleeffecttState extends State<splashrippleeffectt> with TickerProviderStateMixin {
  fetchFileData()async{
    String responseText;
    responseText =await rootBundle.loadString('text/splashrippleeffectt.txt');
    setState(() {
      data=responseText;
    });
  }
    ...
    return Scaffold(
      appBar: AppBar(iconTheme: IconThemeData(color: Colors.white),
        ...
        title: Padding(
          ...
          child: Center(child: Text("Splash ripple Animation",style: TextStyle(color: Colors.white),)),
        ),
      ),
